        ...
        children: [
          ...
          child: Column(children: [
            Row(
              ...
              children: [
              Text("Mis Vehiculos", style: TextStyle(fontFamily: 'pacifico', fontSize: 25, color:  Colors.blue[700],),),
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: FaIcon(FontAwesomeIcons.plusCircle, color: Colors.blue, size: 40,)
                    ),
                  ),
                  ),
  ...
  Widget getVehiculos(List<Car> vehis)
  {
    if(vehis!=null){
      ...
      return Padding(
        ...
        child: Text("Aún no ha agregado ningún vehículo", style: TextStyle(color: Colors.blue[700], fontSize: 18), textAlign: TextAlign.center,),

        );
    }
  }

  Widget carWidget(String name, String tipo, double recorrido, double consumido, double uso){
      ...
      child: Card(
        ...
        child:  Container(
              ...
              child: Column(
                ...
                children: [
                  ListTile(
                      title: Text("Nombre: $name", style: TextStyle(color: Colors.white,fontSize: 20, fontWeight: FontWeight.w600),),
                    ...
                    Padding(
                      ...
                      child: Text('Kilometros: $recorrido',
                            style: TextStyle(color: Colors.white, fontSize: 14,),
                          ),
                    ),
                    Padding(
                      padding: EdgeInsets.fromLTRB(15.0, 0.0, 15.0, 0.0),
                      child: Text('Consumido: $consumido',
                            style: TextStyle(color: Colors.white, fontSize: 14,),
                          ),
                    ),
                    Padding(
